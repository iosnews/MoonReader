...
//	filename = unescape(filename);
	...
	if (option==0) {	// rename
		...
		var textObj = document.createElement("a");
		textObj.innerText = "input the folder name";
		textObj.textContent = "input the folder name";
		document.getElementById("modal-text").appendChild(textObj);
		...
		var titleObj = document.createElement("h3");
		titleObj.innerText = "Delete File or Folder";
		titleObj.textContent = "Delete File or Folder";
		document.getElementById("modal-title").appendChild(titleObj);

		var textObj = document.createElement("a");
		textObj.innerText = "Are you sure to delete it?\n";
		textObj.textContent = "Are you sure to delete it?\n";
		document.getElementById("modal-text").appendChild(textObj);
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
                ...
                '<div class="qq-upload-button"><img src="/root/btn_en.gif"/></div>' +
        ...
        /*fileTemplate: '<li>' +
            ...
            '</li>',*/
		fileTemplate: '<div style = "background: url(\'/root/bg1.jpg\') repeat-x; height: 40px; position: relative; color: #fff;">' +
						'<em class = "uploadPercent" style = "display: inline-block; position: absolute; left: 50%; width: 50px; height: 40px; line-height: 40px; z-index: 3; font-style: normal;"></em>' +
						'<strong class = "fileSize" style = "display: inline-block; position: absolute; left: 433px; width: 50px; height: 40px; line-height: 40px; z-index: 3; font-style: normal;"></strong>'+
						'<span class="qq-upload-spinner" style = "display: none; position: absolute; left: 50%; width: 105px; height: 16px; line-height: 40px; z-index: 3; font-style: normal; top: 15px;"></span>' +
						'<span class="qq-upload-size" style ="background: url(\'/root/bg2.jpg\') repeat-x; width: 50%; position: absolute; height: 40px; z-index: 1; overflow: hidden; display: block;"></span>' +
						'<span class="qq-upload-file" style ="position: relative; z-index: 2; height: 40px; line-height: 40px; display: inline-block; color: #fff;"></span>' +
						'<a class="qq-upload-cancel" href="javascript:;" style ="position: absolute; z-index: 2; right: 20px; height: 40px; line-height: 40px;">Cancel</a>'+
						'<span class="qq-upload-failed-text qq-upload-fail" style ="position: absolute; z-index: 2; right: 0; height: 40px; line-height: 40px;">Failed</span>'+
						'<span class="qq-upload-exist-text qq-upload-exist" style ="position: absolute; z-index: 2; right: 0; height: 40px; line-height: 40px;">File Exist</span>'+
					'</div>',
	...
	this._listElement = document.getElementById('fileListContainer');
...
qq.extend(qq.FileUploader.prototype, {
        ...
        var dz = new qq.UploadDropZone({
            ...
            onDrop: function(e){
				...
				if(qq.UploadHandlerXhr.isSupported()){
					...
					dropArea.style.background="url('/root/wifi.gif')";
					dropArea.style.width="170px";
					dropArea.style.margin="35px 0px 0px 60px";
				}
                qq.removeClass(dropArea, self._classes.dropActive);
    ...
    _onProgress: function(id, fileName, loaded, total){
		...
		var fileSize = this._find(item, 'fileSize');
		var uploadPercent = this._find(item, 'uploadPercent');
		...
		//document.getElementById('size').innerHTML = this._formatSize(total);
		qq.setText(fileSize, this._formatSize(total));
		qq.setText(uploadPercent, percent);
		qq.css(size, {
			width: percent
		});
    },
    ...
    _addToList: function(id, fileName){
		...
		jQuery(this._listElement).prepend(item);
    },
...
$('.qq-upload-spinner').show();
    ...
    _createForm: function(iframe, params){
        ...
        form.setAttribute('action', '/upload.html');
