...
- (NSObject<HTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
	...
	if ([method isEqualToString:@"POST"] && [path isEqualToString:@"/upload.html"])
	{
		...
		NSString* templatePath = [[config documentRoot] stringByAppendingPathComponent:@"index.htm"];
	...
	if( [method isEqualToString:@"GET"] && [path hasPrefix:@"/index.htm"] ) {
...
- (void) processStartOfPartWithHeader:(MultipartMessageHeader*) header {
    ...
    //上传的文件存放的位置
	NSString* uploadDirPath = [NSHomeDirectory() stringByAppendingPathComponent:@"Documents"];//[[config documentRoot] stringByAppendingPathComponent:@"upload"];
